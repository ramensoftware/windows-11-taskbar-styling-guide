...
- If you have another clock, for example from a Rainmeter skin or an application like ElevenClock, then you can hide the taskbar clock in Windows date & time settings 
...
{  
  ...
  "controlStyles[5].styles[1]": "Margin=8,4,8,4",
  "controlStyles[5].styles[2]": "CornerRadius=6",
  "controlStyles[5].styles[3]": "BorderBrush:=<SolidColorBrush Color=\"{ThemeResource SurfaceStrokeColorDefault}\" />",
  ...
  "controlStyles[12].target": "SystemTray.IconView#SystemTrayIcon > Grid#ContainerGrid > ContentPresenter#ContentPresenter > Grid#ContentGrid > SystemTray.TextIconContent > Grid#ContainerGrid",
  "controlStyles[12].styles[0]": "Padding=0",

  "controlStyles[13].target": "SystemTray.StackListView#IconStack > ItemsPresenter > StackPanel > ContentPresenter > SystemTray.IconView#SystemTrayIcon",
