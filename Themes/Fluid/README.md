...
```json
{
  ...
  "controlStyles[4].styles[0]": "Fill:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeAltMedColor}\" TintOpacity=\"0.5\" />",
  ...
  "controlStyles[16].styles[0]": "Background@ActiveNormal:=$NormalBG",
  "controlStyles[16].styles[1]": "Background@ActivePointerOver:=$Hover",
  "controlStyles[16].styles[2]": "Background@ActivePressed:=$PressedBG",
  "controlStyles[16].styles[3]": "Background@InactivePointerOver:=$Hover",
  "controlStyles[16].styles[4]": "Background@InactivePressed:=$PressedBG",
  ...
  "controlStyles[17].styles[0]": "Background@ActiveNormal:=$NormalBG",
  "controlStyles[17].styles[1]": "Background@ActivePointerOver:=$Hover",
  "controlStyles[17].styles[2]": "Background@ActivePressed:=$PressedBG",
  "controlStyles[17].styles[3]": "Background@InactivePointerOver:=$Hover",
  "controlStyles[17].styles[4]": "Background@InactivePressed:=$PressedBG",
  "controlStyles[17].styles[5]": "Background@MultiWindowNormal:=$NormalBG",
  "controlStyles[17].styles[6]": "Background@MultiWindowActive:=$NormalBG",
  "controlStyles[17].styles[7]": "Background@MultiWindowPointerOver:=$Hover",
  "controlStyles[17].styles[8]": "Background@MultiWindowPressed:=$PressedBG",
  ...
  "controlStyles[18].styles[1]": "Background:=$NormalBG",
  ...
  "controlStyles[19].styles[0]": "Background@ActiveNormal:=$NormalBG",
  "controlStyles[19].styles[1]": "Background@ActivePointerOver:=$Hover",
  "controlStyles[19].styles[2]": "Background@ActivePressed:=$PressedBG",
  "controlStyles[19].styles[3]": "Background@InactivePointerOver:=$Hover",
  "controlStyles[19].styles[4]": "Background@InactivePressed:=$PressedBG",
