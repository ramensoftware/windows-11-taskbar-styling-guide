...
"controlStyles[6].target":"Windows.UI.Xaml.Controls.Grid",
  "controlStyles[6].styles[0]":"Shadow:=",
  "controlStyles[6].styles[1]":"BorderThickness:=",
"controlStyles[7].target":"Windows.UI.Xaml.Controls.Border",
...
"controlStyles[14].target":"WindowsInternal.ComposableShell.Experiences.TextInput.Common.InputSwitcher",
