...
```json
{
  ...
  "controlStyles[24].target": "Windows.UI.Xaml.Controls.ScrollViewer > Windows.UI.Xaml.Controls.ScrollContentPresenter > Windows.UI.Xaml.Controls.Border > Windows.UI.Xaml.Controls.Grid",
  "controlStyles[24].styles[0]": "ColumnDefinitions:=<ColumnDefinitionCollection><ColumnDefinition Width=\"*\"/><ColumnDefinition Width=\"*\"/></ColumnDefinitionCollection>",
  "controlStyles[25].target": "Taskbar.AugmentedEntryPointButton > Taskbar.TaskListButtonPanel",
