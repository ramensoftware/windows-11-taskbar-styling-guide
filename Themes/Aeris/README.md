...
```json
{
    ...
    "controlStyles[19].target":"Taskbar.SearchBoxLaunchListButton > Taskbar.TaskListButtonPanel@CommonStates",
    ...
    "controlStyles[22].target":"Taskbar.SearchBoxLaunchListButton > Taskbar.TaskListButtonPanel@CommonStates > Border#BackgroundElement",
    ...
    "controlStyles[25].target":"Grid@ > Border#BackgroundBorder",
    "controlStyles[25].styles[0]":"Padding=0",
    "controlStyles[25].styles[1]":"CornerRadius=0",
    "controlStyles[25].styles[2]":"Margin=0",
    "controlStyles[25].styles[3]":"BorderThickness=0",
    "controlStyles[25].styles[4]":"Background@PointerOver:=$pointerOver",
    "controlStyles[25].styles[5]":"Background@Pressed:=$pressed",
    "controlStyles[26].target":"SystemTray.OmniButton > Grid@CommonStates > Border#BackgroundBorder",
    "controlStyles[26].styles[0]":"Background@PointerOver:=$pointerOver",
    "controlStyles[26].styles[1]":"Background@Pressed:=$pressed",
    "controlStyles[27].target":"SystemTray.Stack#ShowDesktopStack",
    "controlStyles[27].styles[0]":"MinWidth=$showDesktopWidth",
    "controlStyles[27].styles[1]":"MaxWidth=$showDesktopWidth",
    "controlStyles[28].target":"SystemTray.Stack#ShowDesktopStack > Grid > SystemTray.StackListView > Windows.UI.Xaml.Controls.ItemsPresenter > Windows.UI.Xaml.Controls.StackPanel > Windows.UI.Xaml.Controls.ContentPresenter > SystemTray.IconView",
    "controlStyles[28].styles[0]":"MinWidth=$showDesktopWidth",
    "controlStyles[28].styles[1]":"MaxWidth=$showDesktopWidth",
    "controlStyles[29].target":"SystemTray.IconView#SystemTrayIcon > Grid#ContainerGrid@ > Rectangle#ShowDesktopPipe",
    "controlStyles[29].styles[0]":"VerticalAlignment=Stretch",
    "controlStyles[29].styles[1]":"HorizontalAlignment=Stretch",
    "controlStyles[29].styles[2]":"Height=Auto",
    "controlStyles[29].styles[3]":"Width=Auto",
    "controlStyles[29].styles[4]":"Fill@PointerOver:=$pointerOver",
    "controlStyles[29].styles[5]":"Fill@Pressed:=$pressed",
