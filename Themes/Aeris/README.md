...
* The search button's style is incomplete, so it is recommended to disable it from Windows Settings.
...
```json
{
    ...
    "controlStyles[18].target":"Taskbar.SearchBoxButton > Taskbar.TaskListButtonPanel",
    ...
    "controlStyles[20].target":"Border#SearchPillBackgroundElement",
    "controlStyles[20].styles[0]":"BorderThickness=0",
    "controlStyles[20].styles[1]":"CornerRadius=0",
    "controlStyles[20].styles[2]":"Margin=0",
    "controlStyles[21].target":"Taskbar.SearchBoxButton > Taskbar.TaskListButtonPanel > Border#BackgroundElement",
    "controlStyles[21].styles[0]":"BorderThickness=0",
    "controlStyles[21].styles[1]":"CornerRadius=0",
    "controlStyles[21].styles[2]":"Margin=0",
    "controlStyles[22].target":"SearchUx.SearchUI.SearchButtonRootGrid > Border#BackgroundElement",
