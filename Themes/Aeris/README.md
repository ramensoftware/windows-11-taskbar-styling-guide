...
```json
{
    ...
    "controlStyles[18].target":"Taskbar.SearchBoxButton > Taskbar.TaskListButtonPanel > Border#BackgroundElement",
    "controlStyles[18].styles[0]":"Background={ThemeResource SearchPillButtonBackground}",
    "controlStyles[19].target":"Grid@ > Border#BackgroundBorder",
    "controlStyles[19].styles[0]":"Padding=0",
    "controlStyles[19].styles[1]":"CornerRadius=0",
    "controlStyles[19].styles[2]":"Margin=0",
    "controlStyles[19].styles[3]":"BorderThickness=0",
    "controlStyles[19].styles[4]":"Background@PointerOver:=$pointerOver",
    "controlStyles[19].styles[5]":"Background@Pressed:=$pressed",
    "controlStyles[20].target":"SystemTray.OmniButton > Grid@CommonStates > Border#BackgroundBorder",
    "controlStyles[20].styles[0]":"Background@PointerOver:=$pointerOver",
    "controlStyles[20].styles[1]":"Background@Pressed:=$pressed",
    "controlStyles[21].target":"SystemTray.Stack#ShowDesktopStack",
    "controlStyles[21].styles[0]":"MinWidth=$showDesktopWidth",
    "controlStyles[21].styles[1]":"MaxWidth=$showDesktopWidth",
    "controlStyles[22].target":"SystemTray.Stack#ShowDesktopStack > Grid > SystemTray.StackListView > Windows.UI.Xaml.Controls.ItemsPresenter > Windows.UI.Xaml.Controls.StackPanel > Windows.UI.Xaml.Controls.ContentPresenter > SystemTray.IconView",
    "controlStyles[22].styles[0]":"MinWidth=$showDesktopWidth",
    "controlStyles[22].styles[1]":"MaxWidth=$showDesktopWidth",
    "controlStyles[23].target":"SystemTray.IconView#SystemTrayIcon > Grid#ContainerGrid@ > Rectangle#ShowDesktopPipe",
    "controlStyles[23].styles[0]":"VerticalAlignment=Stretch",
    "controlStyles[23].styles[1]":"HorizontalAlignment=Stretch",
    "controlStyles[23].styles[2]":"Height=Auto",
    "controlStyles[23].styles[3]":"Width=Auto",
    "controlStyles[23].styles[4]":"Fill@PointerOver:=$pointerOver",
    "controlStyles[23].styles[5]":"Fill@Pressed:=$pressed",
