...
```json
{
    ...
    "controlStyles[18].styles[2]":"Background@ActiveNormal:=<SolidColorBrush Color=\"$activeColor\" Opacity=\"0.5\"/>",
    "controlStyles[18].styles[3]":"Background@ActivePointerOver:=<SolidColorBrush Color=\"$activeColor\" Opacity=\"0.5\"/>",
    "controlStyles[18].styles[4]":"Background@ActivePressed:=<SolidColorBrush Color=\"$activeColor\" Opacity=\"0.5\"/>",
    "controlStyles[19].target":"SearchUx.SearchUI.SearchButtonRootGrid@CommonStates",
    "controlStyles[19].styles[0]":"Padding=0",
    "controlStyles[19].styles[1]":"Margin=$taskListMargin,0,$taskListMargin,0",
    "controlStyles[19].styles[2]":"Background@ActiveNormal:=<SolidColorBrush Color=\"$activeColor\" Opacity=\"0.5\"/>",
    "controlStyles[19].styles[3]":"Background@ActivePointerOver:=<SolidColorBrush Color=\"$activeColor\" Opacity=\"0.5\"/>",
    "controlStyles[19].styles[4]":"Background@ActivePressed:=<SolidColorBrush Color=\"$activeColor\" Opacity=\"0.5\"/>",
    "controlStyles[20].target":"Taskbar.SearchBoxButton > Taskbar.TaskListButtonPanel@CommonStates > Border#BackgroundElement",
    "controlStyles[20].styles[0]":"BorderThickness=0",
    "controlStyles[20].styles[1]":"CornerRadius=0",
    "controlStyles[20].styles[2]":"Margin=0",
    "controlStyles[20].styles[3]":"Background@InactiveNormal:=$transparent",
    "controlStyles[20].styles[4]":"Background@InactivePointerOver:=$pointerOver",
    "controlStyles[20].styles[5]":"Background@InactivePressed:=$pressed",
    "controlStyles[20].styles[6]":"Background@ActiveNormal:=$transparent",
    "controlStyles[20].styles[7]":"Background@ActivePointerOver:=$pointerOver",
    "controlStyles[20].styles[8]":"Background@ActivePressed:=$pressed",
    "controlStyles[21].target":"SearchUx.SearchUI.SearchButtonRootGrid@CommonStates > Border#BackgroundElement",
    "controlStyles[21].styles[0]":"BorderThickness=0",
    "controlStyles[21].styles[1]":"CornerRadius=0",
    "controlStyles[21].styles[2]":"Margin=0",
    "controlStyles[21].styles[3]":"Background@InactiveNormal:=$transparent",
    "controlStyles[21].styles[4]":"Background@InactivePointerOver:=$pointerOver",
    "controlStyles[21].styles[5]":"Background@InactivePressed:=$pressed",
    "controlStyles[21].styles[6]":"Background@ActiveNormal:=$transparent",
    "controlStyles[21].styles[7]":"Background@ActivePointerOver:=$pointerOver",
    "controlStyles[21].styles[8]":"Background@ActivePressed:=$pressed",
    "controlStyles[22].target":"Border#SearchPillBackgroundElement",
    "controlStyles[22].styles[0]":"BorderThickness=0",
    "controlStyles[22].styles[1]":"CornerRadius=0",
    "controlStyles[22].styles[2]":"Margin=0",
    "controlStyles[23].target":"Grid@ > Border#BackgroundBorder",
    "controlStyles[23].styles[0]":"Padding=0",
    "controlStyles[23].styles[1]":"CornerRadius=0",
    "controlStyles[23].styles[2]":"Margin=0",
    "controlStyles[23].styles[3]":"BorderThickness=0",
    "controlStyles[23].styles[4]":"Background@PointerOver:=$pointerOver",
    "controlStyles[23].styles[5]":"Background@Pressed:=$pressed",
    "controlStyles[24].target":"SystemTray.OmniButton > Grid@CommonStates > Border#BackgroundBorder",
    "controlStyles[24].styles[0]":"Background@PointerOver:=$pointerOver",
    "controlStyles[24].styles[1]":"Background@Pressed:=$pressed",
    "controlStyles[25].target":"SystemTray.Stack#ShowDesktopStack",
    "controlStyles[25].styles[0]":"MinWidth=$showDesktopWidth",
    "controlStyles[25].styles[1]":"MaxWidth=$showDesktopWidth",
    "controlStyles[26].target":"SystemTray.Stack#ShowDesktopStack > Grid > SystemTray.StackListView > Windows.UI.Xaml.Controls.ItemsPresenter > Windows.UI.Xaml.Controls.StackPanel > Windows.UI.Xaml.Controls.ContentPresenter > SystemTray.IconView",
    "controlStyles[26].styles[0]":"MinWidth=$showDesktopWidth",
    "controlStyles[26].styles[1]":"MaxWidth=$showDesktopWidth",
    "controlStyles[27].target":"SystemTray.IconView#SystemTrayIcon > Grid#ContainerGrid@ > Rectangle#ShowDesktopPipe",
    "controlStyles[27].styles[0]":"VerticalAlignment=Stretch",
    "controlStyles[27].styles[1]":"HorizontalAlignment=Stretch",
    "controlStyles[27].styles[2]":"Height=Auto",
    "controlStyles[27].styles[3]":"Width=Auto",
    "controlStyles[27].styles[4]":"Fill@PointerOver:=$pointerOver",
    "controlStyles[27].styles[5]":"Fill@Pressed:=$pressed",
