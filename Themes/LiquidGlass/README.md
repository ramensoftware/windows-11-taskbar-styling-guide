...
```json
{
  ...
  "controlStyles[40].target": "SystemTray.SystemTrayFrame",
  "controlStyles[40].styles[0]": "HorizontalAlignment=Right",
  "controlStyles[41].target": "Grid#AugmentedEntryPointContentGrid",
