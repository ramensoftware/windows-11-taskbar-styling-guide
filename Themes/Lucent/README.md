...
```json
{
  ...
  "controlStyles[4].styles[1]": "Background@ActiveRunningIndicator:=<SolidColorBrush Color=\"{ThemeResource SystemAccentColorLight3}\"/>",
  "controlStyles[4].styles[2]": "Background@InactiveRunningIndicator:=<LinearGradientBrush StartPoint=\"0,0.5\" EndPoint=\"0,1\"><GradientStop Color=\"#3300290c\" Offset=\"0.1\" /><GradientStop Color=\"{ThemeResource SystemAccentColorDark2}\" Offset=\"0.9\" /><GradientStop Color=\"#AAFFFFFF\" Offset=\"1.0\" /></LinearGradientBrush>",
  "controlStyles[4].styles[3]": "Margin@ActiveRunningIndicator=-4",
  "controlStyles[4].styles[4]": "Margin=0,-1,0,-1",
  "controlStyles[4].styles[5]": "CornerRadius@ActiveRunningIndicator=2",
  "controlStyles[4].styles[6]": "CornerRadius@InactiveRunningIndicator=0",
  "controlStyles[4].styles[7]": "Margin@InactiveRunningIndicator=-4",
  "controlStyles[4].styles[8]": "Margin@RequestingAttentionRunningIndicator=0,-4,0,-4",
  "controlStyles[4].styles[9]": "CornerRadius@RequestingAttentionRunningIndicator=2",
  ...
  "controlStyles[5].styles[3]": "Margin=0,0,3,0",
...
```json
{
  ...
  "controlStyles[4].target": "Taskbar.TaskListLabeledButtonPanel@RunningIndicatorStates > Border#BackgroundElement",
  "controlStyles[4].styles[0]": "CornerRadius=15",
  "controlStyles[4].styles[1]": "Background@ActiveRunningIndicator:=#FCFCFC",
  "controlStyles[4].styles[2]": "Background@InactiveRunningIndicator:=<LinearGradientBrush StartPoint=\"0,0.5\" EndPoint=\"0,1\"><GradientStop Color=\"#3300290c\" Offset=\"0.1\" /><GradientStop Color=\"{ThemeResource SystemAccentColorDark2}\" Offset=\"0.9\" /><GradientStop Color=\"#AAFFFFFF\" Offset=\"1.0\" /></LinearGradientBrush>",
  "controlStyles[4].styles[3]": "Margin@ActiveRunningIndicator=-4",
  "controlStyles[4].styles[4]": "Margin=0,-1,0,-1",
  "controlStyles[4].styles[5]": "CornerRadius@ActiveRunningIndicator=2",
