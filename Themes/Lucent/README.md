...
```json
{
  ...
  "controlStyles[13].styles[0]": "Background@ActiveNormal:=<SolidColorBrush Color=\"{ThemeResource SystemAccentColorLight3}\"/>",
  "controlStyles[13].styles[1]": "Background@ActivePointerOver:=<SolidColorBrush Color=\"{ThemeResource SystemAccentColorLight2}\"/>",
  "controlStyles[13].styles[2]": "Background@InactivePointerOver=#EBEBEB",
  "controlStyles[13].styles[3]": "Background@InactivePressed=#BBBBBB",
  "controlStyles[13].styles[4]": "Background@ActivePressed:=<SolidColorBrush Color=\"{ThemeResource SystemAccentColorLight1}\"/>",
  "controlStyles[13].styles[5]": "Background@RequestingAttention=#FFE9AFAA",
  "controlStyles[13].styles[6]": "Background@RequestingAttentionPointerOver=#FFF8E7E5",
  "controlStyles[13].styles[7]": "Background@RequestingAttentionPressed=#FFFEEEF0",
...
```json
{
  ...
  "controlStyles[12].styles[0]": "Margin=12,0,0,0",
  "controlStyles[13].target": "Taskbar.TaskListLabeledButtonPanel@CommonStates",
  "controlStyles[13].styles[0]": "Background@ActiveNormal:=#FCFCFC",
  "controlStyles[13].styles[1]": "Background@ActivePointerOver:=#BBBBBB",
  "controlStyles[13].styles[2]": "Background@InactivePointerOver=#EBEBEB",
  "controlStyles[13].styles[3]": "Background@InactivePressed=#BBBBBB",
  "controlStyles[13].styles[4]": "Background@ActivePressed=#BBBBBB",
  "controlStyles[13].styles[5]": "Background@RequestingAttention=#FFE9AFAA",
  "controlStyles[13].styles[6]": "Background@RequestingAttentionPointerOver=#FFF8E7E5",
  "controlStyles[13].styles[7]": "Background@RequestingAttentionPressed=#FFFEEEF0",
  "controlStyles[14].target": "Taskbar.TaskListLabeledButtonPanel@CommonStates > Border",
