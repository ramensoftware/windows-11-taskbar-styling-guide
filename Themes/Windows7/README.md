...
```json
{
	...
	"controlStyles[35].styles[0]": "BorderBrush@InactivePointerOver:=<ImageBrush Stretch=\"Uniform\" ImageSource=\"$trayPointerOver\" />",
	"controlStyles[35].styles[1]": "BorderThickness=0,0,0,8",
