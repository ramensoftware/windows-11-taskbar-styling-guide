...
This theme is mostly a proof of concept, and due to the limitations of the XAML taskbar it is not accurate to Windows 7. If you want an accurate Windows 7 taskbar, check out [Explorer7](https://winclassic.net/thread/3005/explorer7-restoring-windows-7-experience) or ep_taskbar.
