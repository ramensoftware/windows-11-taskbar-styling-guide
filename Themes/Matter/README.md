...
```json
{
    ...
    "controlStyles[10].styles[3]": "VerticalAlignment = Stretch",
    "controlStyles[10].styles[4]": "Height = 30",
    ...
    "controlStyles[13].styles[2]": "Margin=0,5,2,5",
    "controlStyles[13].styles[3]": "Padding=2,0,0,0",
    "controlStyles[13].styles[4]": "Width = 48",
    "controlStyles[13].styles[5]": "MinWidth = 48",
    "controlStyles[13].styles[6]": "MaxWidth = 48",
    "controlStyles[13].styles[7]": "HorizontalAlignment = Left",
    "controlStyles[13].styles[8]": "VerticalAlignment = Center",
    "controlStyles[13].styles[9]": "ClipToBounds = True",
    ...
    "controlStyles[32].styles[0]": "CornerRadius = $mainRadius",
    "controlStyles[32].styles[1]": "Padding=2,0,0,0",
    "controlStyles[33].target": "SystemTray.ChevronIconView",
    "controlStyles[33].styles[0]": "Background :=$overlay2",
    "controlStyles[33].styles[1]": "CornerRadius = 8",
    "controlStyles[33].styles[2]": "Margin = 2",
    "controlStyles[34].target": "SystemTray.NotifyIconView#NotifyItemIcon",
    "controlStyles[34].styles[0]": "Background :=$overlay2",
    "controlStyles[34].styles[1]": "CornerRadius = 8",
    "controlStyles[34].styles[2]": "Margin = 2",
    "controlStyles[34].styles[3]": "Background@PointerOver :=$overlay",
    "controlStyles[34].styles[4]": "Background@Pressed :=$active",
    "controlStyles[35].target": "SystemTray.IconView#SystemTrayIcon",
    "controlStyles[35].styles[0]": "Background :=$overlay2",
    "controlStyles[35].styles[1]": "CornerRadius = 8",
    "controlStyles[36].target": "SystemTray.OmniButton#ControlCenterButton",
    "controlStyles[36].styles[0]": "Background :=$overlay2",
    "controlStyles[36].styles[1]": "CornerRadius = 8",
    "controlStyles[37].target": "SystemTray.OmniButton#NotificationCenterButton",
    "controlStyles[37].styles[0]": "Background :=$overlay2",
    "controlStyles[37].styles[1]": "CornerRadius = 8",
    "controlStyles[38].target": "Windows.UI.Xaml.Controls.StackPanel",
    "controlStyles[38].styles[0]": "Padding=2",
