...
```json
{
  ...
  "controlStyles[13].target": "Border#MultiWindowElement",
  "controlStyles[13].styles[0]": "HorizontalAlignment=0",
  "controlStyles[13].styles[1]": "MinWidth=40",
  "controlStyles[13].styles[2]": "BorderThickness=0",
  "controlStyles[13].styles[3]": "Margin=1",
  "controlStyles[14].target": "TextBlock#TimeInnerTextBlock",
  "controlStyles[14].styles[0]": "Foreground=White",
  "controlStyles[15].target": "TextBlock#DateInnerTextBlock",
  "controlStyles[15].styles[0]": "Foreground=White",
  ...
  "controlStyles[20].styles[0]": "Margin=10,0,-10,0",
  "controlStyles[21].target": "Grid#AugmentedEntryPointContentGrid",
  "controlStyles[21].styles[0]": "Margin=10,0,-5,0",
  "controlStyles[22].target": "taskbar:TaskListLabeledButtonPanel@CommonStates > Border[1]",
  ...
  "controlStyles[22].styles[7]": "RenderTransform:=<ScaleTransform ScaleX=\"0.65\" />",
  "controlStyles[22].styles[8]": "Margin=0,0,5,0",
  ...
  "controlStyles[23].styles[1]": "Background:=<AcrylicBrush TintColor=\"Black\" TintOpacity=\"0.8\" FallbackColor=\"#BB222222\" />",
  "controlStyles[23].styles[2]": "Margin=0,-4,0,-4",
  "controlStyles[24].target": "Taskbar.ExperienceToggleButton#LaunchListButton[AutomationProperties.Name=Task View] > Taskbar.TaskListButtonPanel > Border",
  "controlStyles[24].styles[0]": "CornerRadius=0,5,5,0",
  "controlStyles[24].styles[1]": "Margin=0,-2,0,-2",
  "controlStyles[24].styles[2]": "Background:=<AcrylicBrush TintOpacity=\"0.82\" TintColor=\"Black\" />",
  "controlStyles[25].target": "SearchUx.SearchUI.SearchBoxButton",
  "controlStyles[25].styles[0]": "Background:=<AcrylicBrush TintOpacity=\"0.8\" TintColor=\"Black\" FallbackColor=\"#BB333333\" />",
  "controlStyles[26].target": "SearchUx.SearchUI.SearchButtonRootGrid > Border",
  "controlStyles[26].styles[0]": "Padding=0",
  "controlStyles[26].styles[1]": "BorderThickness=27.5",
  "controlStyles[26].styles[2]": "CornerRadius=0",
  "controlStyles[26].styles[3]": "BorderBrush:=<AcrylicBrush TintOpacity=\"0.8\" TintColor=\"Black\" FallbackColor=\"#BB333333\" />",
  "controlStyles[26].styles[4]": "Margin=0,0,-8,0",
  "controlStyles[27].target": "SearchUx.SearchUI.SearchButtonRootGrid",
  "controlStyles[27].styles[0]": "Background=Transparent",
  "controlStyles[27].styles[1]": "Padding=-4,-4,-4,-4",
  "controlStyles[27].styles[2]": "MinWidth=44",
  "controlStyles[27].styles[3]": "CornerRadius=0,5,5,0",
  "controlStyles[27].styles[4]": "Margin=0,4,0,4",
  "controlStyles[28].target": "Taskbar.ExperienceToggleButton#LaunchListButton[AutomationProperties.AutomationId=StartButton] > Taskbar.TaskListButtonPanel",
  "controlStyles[28].styles[0]": "Margin=0,-2,4,-2",
  "controlStyles[29].target": "SearchUx.SearchUI.SearchBoxButton#SearchBox > SearchUx.SearchUI.SearchButtonRootGrid",
  "controlStyles[29].styles[0]": "Margin=0,4,-8,4",
  "controlStyles[30].target": "Taskbar.ExperienceToggleButton#LaunchListButton[AutomationProperties.Name=Task View] > Taskbar.TaskListButtonPanel",
  "controlStyles[30].styles[0]": "Margin=-12,0,0,0",
  "controlStyles[31].target": "SearchUx.SearchUI.SearchButtonRootGrid > Microsoft.UI.Xaml.Controls.AnimatedVisualPlayer#Icon",
  "controlStyles[31].styles[0]": "Margin=-6,0,0,0",
  "controlStyles[32].styles[0]": "Margin=14,0,0,0",
  "controlStyles[32].target": "SearchUx.SearchUI.SearchBoxButton#SearchBox > SearchUx.SearchUI.SearchButtonRootGrid@CommonStates > Microsoft.UI.Xaml.Controls.AnimatedVisualPlayer#Icon",
  "controlStyles[33].target": "taskbar:TaskListLabeledButtonPanel@RunningIndicatorStates > Border#BackgroundElement",
  "controlStyles[33].styles[0]": "Background@NoRunningIndicator:=<AcrylicBrush TintOpacity=\"0.2\" TintColor=\"Black\" FallbackColor=\"#BB222222\" />",
