...
```json
{
  "controlStyles[0].styles[0]":"Background:=<WindhawkBlur BlurAmount=\"5\" TintColor=\"{ThemeResource Chrome}\" TintOpacity=\"0.3\"  />",
  ...
  "controlStyles[2].styles[3]":"Background:=$ThemeLayer",
  "controlStyles[2].styles[4]":"BorderThickness=1",
  "controlStyles[2].styles[5]":"BorderBrush:=$ThemeBorder",
  ...
  "controlStyles[7].styles[4]":"BorderBrush:=$ThemeBorder",
  ...
  "controlStyles[10].styles[1]":"CornerRadius=$InnerRadius",
  ...
  "controlStyles[13].styles[2]":"BorderBrush:=$ThemeBorder",
  "controlStyles[13].styles[3]":"BorderThickness=1",
  "controlStyles[13].target":"Taskbar.TaskListButton",
  "controlStyles[14].styles[0]":"Background:=<SolidColorBrush Color=\"{ThemeResource ControlFillColorSecondary}\" Opacity=\"0.9\" />",
  "controlStyles[14].styles[1]":"BorderBrush:=$ThemeBorder",
  "controlStyles[14].styles[2]":"BorderThickness=1",
  "controlStyles[14].styles[3]":"CornerRadius=$InnerRadius",
  ...
  "controlStyles[16].styles[1]":"CornerRadius=$OuterRadius",
  "controlStyles[16].styles[2]":"BorderBrush:=$ThemeBorder",
  ...
  "controlStyles[18].styles[1]":"CornerRadius=$OuterRadius",
  "controlStyles[18].styles[2]":"BorderBrush:=$ThemeBorder",
  "controlStyles[18].target":"Windows.UI.Xaml.Hosting.DesktopWindowXamlSource",
  "controlStyles[19].styles[0]":"Background:=$ThemeLayer",
  "controlStyles[19].styles[1]":"CornerRadius=$OuterRadius",
  "controlStyles[19].target":"MenuFlyoutPresenter",
  "controlStyles[20].styles[0]":"Background:=$ThemeLayer",
  "controlStyles[20].styles[1]":"CornerRadius=$OuterRadius",
  "controlStyles[20].target":"ToolTip > ContentPresenter#LayoutRoot",
  "controlStyles[21].styles[0]":"Background:=$ThemeLayer",
  "controlStyles[21].styles[1]":"CornerRadius=$OuterRadius",
  "controlStyles[21].styles[2]":"BorderBrush:=$ThemeBorder",
  "controlStyles[21].styles[3]":"BorderThickness=1",
  "controlStyles[21].target":"Border#OverflowFlyoutBackgroundBorder",
  "controlStyles[22].styles[0]":"Background:=$ThemeLayer",
  "controlStyles[22].styles[1]":"CornerRadius=$OuterRadius",
  "controlStyles[22].styles[2]":"BorderThickness=1",
  "controlStyles[22].styles[3]":"BorderBrush:=$ThemeBorder",
  "controlStyles[22].styles[4]":"Height=46",
  "controlStyles[22].target":"Grid#ConfirmatorMainGrid",
  "controlStyles[23].styles[0]":"Background:=<SolidColorBrush Color=\"{ThemeResource Chrome}\" Opacity=\"0.7\" />",
  "controlStyles[23].styles[1]":"CornerRadius=$OuterRadius",
  "controlStyles[23].styles[2]":"BorderBrush:=$ThemeBorder",
  ...
  "controlStyles[29].styles[0]":"CornerRadius=$OuterRadius",
  "controlStyles[29].styles[1]":"BorderThickness=1",
  "controlStyles[29].styles[2]":"BorderBrush:=$ThemeBorder",
  "controlStyles[29].target":"Taskbar.TaskItemThumbnailView > Grid > Border",
  ...
  "controlStyles[32].styles[1]":"Foreground:=<SolidColorBrush Color=\"{ThemeResource Accent1}\" />",
  ...
  "controlStyles[33].styles[1]":"Foreground:=<SolidColorBrush Color=\"{ThemeResource Accent1}\" />",
  ...
  "controlStyles[34].styles[1]":"CornerRadius=$InnerRadius",
  ...
  "controlStyles[39].styles[0]":"Background:=$ThemeLayer",
  "controlStyles[39].styles[1]":"BorderBrush:=$ThemeBorder",
  ...
  "controlStyles[40].styles[0]":"Background:=$ThemeLayer",
  ...
  "controlStyles[41].styles[0]":"Background:=$ThemeLayer",
  "controlStyles[41].target":"WindowsInternal.ComposableShell.Experiences.Switcher.SwitchItemListViewItem > Grid > Border",
  "controlStyles[42].styles[0]":"Background:=$ThemeLayer",
  "controlStyles[42].target":"Grid#OverflowRootGrid > Border",
  "controlStyles[43].styles[0]":"Fill=$ThemeLayer",
  "controlStyles[43].styles[1]":"CornerRadius=$OuterRadius",
  "controlStyles[43].target":"Taskbar.TaskbarBackground#HoverFlyoutBackgroundControl > Grid > Rectangle#BackgroundFill",
  "styleConstants[0]":"ThemeBlur=<WindhawkBlur BlurAmount=\"10\" TintColor=\"{ThemeResource Chrome}\" TintOpacity=\"0.5\"  />",
  "styleConstants[1]":"ThemeLayer=<AcrylicBrush BackgroundSource=\"Backdrop\" TintColor=\"{ThemeResource Chrome}\" TintOpacity=\"{ThemeResource bgOpacity}\" TintLuminosityOpacity=\"{ThemeResource bgLuminosity}\" FallbackColor=\"{ThemeResource Chrome}\" />",
  "styleConstants[2]":"OuterRadius=10",
  "styleConstants[3]":"InnerRadius=6",
  "styleConstants[4]":"ThemeBorder=<SolidColorBrush Color=\"{ThemeResource SurfaceStrokeColorDefault}\" Opacity=\"0.6\" />",
  "theme":"",
  ...
  "themeResourceVariables[2]":"bgOpacity@Light=0.1",
  "themeResourceVariables[3]":"bgLuminosity@Light=1",
  "themeResourceVariables[4]":"bgOpacity@Dark=0.5",
  "themeResourceVariables[5]":"bgLuminosity@Dark=0.85",
  "themeResourceVariables[6]":"Chrome@Light={ThemeResource SystemChromeLowColor}",
  "themeResourceVariables[7]":"Chrome@Dark={ThemeResource SystemChromeAltHighColor}"
}
```
</details>
