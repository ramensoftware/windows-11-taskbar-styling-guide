...
```json
{
  ...
  "controlStyles[32].styles[4]":"Foreground:=<SolidColorBrush Color=\"{ThemeResource AutoAccent}\" />",
  "controlStyles[32].styles[5]":"Canvas.ZIndex=-1",
  ...
  "controlStyles[33].styles[4]":"Foreground:=<SolidColorBrush Color=\"{ThemeResource AutoAccent}\" />",
  "controlStyles[33].styles[5]":"Canvas.ZIndex=-1",
