...
```json
{
  ...
  "controlStyles[2].styles[5]":"BorderBrush:=$b1",
  ...
  "controlStyles[7].styles[4]":"BorderBrush:=$b1",
  ...
  "controlStyles[8].styles[1]":"CornerRadius=$r2",
  ...
  "controlStyles[10].styles[1]":"CornerRadius=$r2",
  ...
  "controlStyles[13].styles[0]":"CornerRadius=$r2",
  "controlStyles[13].styles[1]":"Margin=0,-1,0,-1",
  "controlStyles[13].styles[2]":"BorderBrush=$b1",
  ...
  "controlStyles[14].styles[1]":"BorderBrush:=$b1",
  "controlStyles[14].styles[2]":"BorderThickness=1",
  "controlStyles[14].styles[3]":"CornerRadius=$r2",
  ...
  "controlStyles[16].styles[1]":"CornerRadius=$r1",
  "controlStyles[16].styles[2]":"BorderBrush=$b1",
  ...
  "controlStyles[18].styles[1]":"CornerRadius=$r1",
  "controlStyles[18].styles[2]":"BorderBrush=$b1",
  "controlStyles[18].target":"Windows.UI.Xaml.Hosting.DesktopWindowXamlSource",
  "controlStyles[19].styles[0]":"Background:=$ThemeBack",
  "controlStyles[19].styles[1]":"CornerRadius=$r1",
  ...
  "controlStyles[23].styles[2]":"BorderBrush:=$b1",
  ...
  "controlStyles[29].styles[1]":"CornerRadius=$r1",
  ...
  "controlStyles[32].styles[0]":"Content:=",
  "controlStyles[32].styles[1]":"FontFamily=Segoe Fluent Icons",
  "controlStyles[32].styles[2]":"FontSize=16",
  "controlStyles[32].styles[3]":"Margin=9,13,0,0",
  ...
  "controlStyles[33].styles[0]":"Content:=",
  "controlStyles[33].styles[1]":"FontFamily=Segoe Fluent Icons",
  "controlStyles[33].styles[2]":"FontSize=15",
  "controlStyles[33].styles[3]":"Margin=10,13,0,0",
  ...
  "controlStyles[34].styles[1]":"CornerRadius=$r2",
  ...
  "controlStyles[39].styles[1]":"BorderBrush=$b1",
  ...
  "styleConstants[2]":"r1=10",
  "styleConstants[3]":"r2=6",
  "styleConstants[4]":"b1=<SolidColorBrush Color=\"{ThemeResource SurfaceStrokeColorDefault}\" Opacity=\"0.6\" />",
  "theme":""
}
```
</details>
