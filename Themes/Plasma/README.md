...
```json
{
	...
	"controlStyles[6].styles[0]": "Fill:=$taskbarBackground",
	...
	"styleConstants[0]": "taskbarBackground=<AcrylicBrush TintColor=\"#2a2e32\" TintOpacity=\"0.8\" FallbackColor=\"#2a2e32\" />",
	"styleConstants[1]": "taskbandInactiveNormal=<SolidColorBrush Color=\"Gray\" Opacity=\"0.25\" />",
	"styleConstants[2]": "taskbandPointerOver=<SolidColorBrush Color=\"{ThemeResource SystemAccentColorLight1}\" Opacity=\"0.4\" />",
	"styleConstants[3]": "taskbandActive=<SolidColorBrush Color=\"{ThemeResource SystemAccentColorLight1}\" Opacity=\"0.5\" />",
	"styleConstants[4]": "indicatorActive=<SolidColorBrush Color=\"{ThemeResource SystemAccentColorLight2}\" Opacity=\"0.7\" />",
	"styleConstants[5]": "indicatorInactive=<SolidColorBrush Color=\"Gray\" Opacity=\"0.7\" />",
	"styleConstants[6]": "indicatorPointerOver=<SolidColorBrush Color=\"{ThemeResource SystemAccentColorLight2}\" Opacity=\"0.8\" />",
	"styleConstants[7]": "taskbandAttention=<SolidColorBrush Color=\"#ce640c\" Opacity=\"0.5\" />",
	"styleConstants[8]": "indicatorAttention=<SolidColorBrush Color=\"#ce640c\" Opacity=\"0.9\" />",
	"styleConstants[9]": "selectionBorder=<LinearGradientBrush StartPoint='0,0' EndPoint='1,0'><GradientStop Color='Transparent' Offset='0.0' /><GradientStop Color='Transparent' Offset='0.2' /><GradientStop Color='{ThemeResource SystemAccentColorLight2}' Offset='0.2' /><GradientStop Color='{ThemeResource SystemAccentColorLight2}' Offset='0.8' /><GradientStop Color='Transparent' Offset='0.8' /><GradientStop Color='Transparent' Offset='1.0' /></LinearGradientBrush>",
	"styleConstants[10]": "selectionBorderExtended=<SolidColorBrush Color=\"{ThemeResource SystemAccentColorLight2}\" />",
	"styleConstants[11]": "desktopButton=https://raw.githubusercontent.com/SandTechStuff/windows-11-taskbar-styling-guide/refs/heads/theme/Themes/Plasma/ThemeResources/desktop.png",
	"styleConstants[12]": "plusIndicator=https://raw.githubusercontent.com/SandTechStuff/windows-11-taskbar-styling-guide/refs/heads/theme/Themes/Plasma/ThemeResources/plus.png",
	"styleConstants[13]": "StartButton=default"
}
```
</details>
