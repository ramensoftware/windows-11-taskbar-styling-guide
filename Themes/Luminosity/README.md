...
```json
{
  ...
  "controlStyles[4].target": "Windows.UI.Xaml.Controls.Border#MultiWindowElement",
  ...
  "controlStyles[5].styles[1]": "Margin=0,0,2,0",
  "controlStyles[6].target": "SystemTray.NotifyIconView > Windows.UI.Xaml.Controls.Grid#ContainerGrid > Windows.UI.Xaml.Controls.Border#BackgroundBorder",
  "controlStyles[6].styles[0]": "CornerRadius=$bcr",
  "controlStyles[6].styles[1]": "Margin=2,4,2,4",
  "controlStyles[7].target": "SystemTray.IconView#SystemTrayIcon > Windows.UI.Xaml.Controls.Grid#ContainerGrid > Windows.UI.Xaml.Controls.Border#BackgroundBorder",
  "controlStyles[7].styles[0]": "CornerRadius=$bcr",
  "controlStyles[7].styles[1]": "Margin=2,4,2,4",
  "controlStyles[8].target": "SystemTray.OmniButton#ControlCenterButton > Windows.UI.Xaml.Controls.Grid > Windows.UI.Xaml.Controls.Border#BackgroundBorder",
  "controlStyles[8].styles[0]": "CornerRadius=$bcr",
  "controlStyles[8].styles[1]": "Margin=2,4,2,4",
  "controlStyles[9].target": "SystemTray.OmniButton#NotificationCenterButton > Windows.UI.Xaml.Controls.Grid > Windows.UI.Xaml.Controls.Border#BackgroundBorder",
  ...
  "controlStyles[11].target": "Windows.UI.Xaml.Controls.Grid#ConfirmatorMainGrid",
  ...
  "controlStyles[11].styles[4]": "Shadow:=",
  "controlStyles[12].target": "Windows.UI.Xaml.Shapes.Rectangle#HorizontalTrackRect",
  "controlStyles[12].styles[0]": "Fill:=#10FFFFFF",
  "controlStyles[13].target": "Taskbar.TaskbarBackground#HoverFlyoutBackgroundControl > Grid > Rectangle#BackgroundFill",
  "controlStyles[13].styles[0]": "Fill:=$t",
  "controlStyles[14].target": "Windows.UI.Xaml.Controls.Grid#HoverFlyoutGrid > Windows.UI.Xaml.Controls.Border#HoverFlyoutBackground",
  ...
  "controlStyles[14].styles[4]": "Shadow:=",
  ...
  "controlStyles[16].target": "Windows.UI.Xaml.Controls.Button#CloseButton",
  "controlStyles[16].styles[0]": "CornerRadius=$mcr",
  "controlStyles[17].target": "Windows.UI.Xaml.Controls.ContentPresenter#BorderElement",
  "controlStyles[17].styles[0]": "CornerRadius=16",
  "controlStyles[17].styles[1]": "Margin=-1,-1,-1,-1",
  "controlStyles[18].target": "Windows.UI.Xaml.Controls.Grid#ModalRootGrid > Windows.UI.Xaml.Controls.Border#BackgroundElement",
  ...
  "controlStyles[19].target": "Windows.UI.Xaml.Controls.Border#BackgroundDimmingLayer",
  "controlStyles[19].styles[0]": "Background:=<WindhawkBlur BlurAmount=\"30\" TintColor=\"#00000000\" />",
  ...
  "controlStyles[21].styles[1]": "Visibility=Visible",
  "controlStyles[21].styles[2]": "MaxWidth:=900",
  "controlStyles[21].styles[3]": "BorderThickness=$bt",
  "controlStyles[21].styles[4]": "BorderBrush=$bb",
  "controlStyles[21].styles[5]": "Shadow:=",
  "controlStyles[22].target": "Windows.UI.Xaml.Controls.Grid#MainGrid",
  ...
  "controlStyles[23].target": "Windows.UI.Xaml.Controls.Button#VirtualDesktopElementCloseButton",
  "controlStyles[23].styles[0]": "CornerRadius=$bcr",
  "controlStyles[24].target": "Windows.UI.Xaml.Controls.Border#SnapBarBorder",
  "controlStyles[24].styles[0]": "Background:=$mbg",
  "controlStyles[24].styles[1]": "CornerRadius=$mcr",
  "controlStyles[24].styles[2]": "RenderTransform:=<TranslateTransform X=\"0\" Y=\"-20\" />",
  "controlStyles[24].styles[3]": "Margin=0,0,0,-10",
  "controlStyles[24].styles[4]": "Shadow:=",
  "controlStyles[25].target": "Windows.UI.Xaml.Controls.Border#SnapPickerBorder",
  ...
  "controlStyles[26].target": "Windows.UI.Xaml.Controls.FlyoutPresenter > Border",
  "controlStyles[26].styles[0]": "Shadow:=",
  ...
  "controlStyles[27].styles[2]": "Shadow:=",
  "controlStyles[28].target": "MenuFlyoutPresenter > Border",
  "controlStyles[28].styles[0]": "CornerRadius=$mcr",
  "controlStyles[28].styles[1]": "BorderThickness=$bt",
  "controlStyles[28].styles[2]": "BorderBrush=$bb",
  "controlStyles[29].target": "Windows.UI.Xaml.Controls.MenuFlyoutItem",
  "controlStyles[29].styles[0]": "CornerRadius=$bcr",
  "controlStyles[30].target": "Windows.UI.Xaml.Controls.MenuFlyoutSubItem",
  "controlStyles[30].styles[0]": "CornerRadius=$bcr",
  "controlStyles[31].target": "Windows.UI.Xaml.Controls.ToolTip > Windows.UI.Xaml.Controls.ContentPresenter#LayoutRoot",
  ...
  "controlStyles[32].styles[0]": "Height=30",
  "controlStyles[33].target": "Windows.UI.Xaml.Controls.Border#LargeTicker1",
  "controlStyles[33].styles[0]": "Margin=1,-7,0,0",
  "controlStyles[33].styles[1]": "RenderTransform:=<ScaleTransform ScaleX=\"0.75\" ScaleY=\"0.75\" />",
  "controlStyles[34].target": "Windows.UI.Xaml.Controls.Border#SearchPillBackgroundElement",
  "controlStyles[34].styles[0]": "CornerRadius=$bcr",
  "controlStyles[35].target": "SearchUx.SearchUI.SearchButtonControl",
  "controlStyles[35].styles[0]": "Margin=0,-4,0,-4",
  "controlStyles[36].target": "Microsoft.UI.Xaml.Controls.AnimatedVisualPlayer#Icon",
  "controlStyles[37].target": "Windows.UI.Xaml.Controls.Image#Icon",
  "controlStyles[36].styles[0]": "Width=16",
  "controlStyles[37].styles[0]": "Width=16",
  "controlStyles[36].styles[1]": "Height=16",
  "controlStyles[37].styles[1]": "Height=16",
  "controlStyles[38].target": "Grid#SystemTrayFrameGrid",
  "controlStyles[38].styles[0]": "Margin=0,0,0,18",
  "controlStyles[39].target": "SystemTray.TextIconContent > Grid#ContainerGrid > SystemTray.AdaptiveTextBlock#Base > TextBlock#InnerTextBlock",
  "controlStyles[39].styles[0]": "FontSize=14",
  "controlStyles[40].target": "SystemTray.ImageIconContent > Grid#ContainerGrid > Image",
  "controlStyles[40].styles[0]": "Width=14",
  "controlStyles[40].styles[1]": "Height=14"
}
```
</details>
