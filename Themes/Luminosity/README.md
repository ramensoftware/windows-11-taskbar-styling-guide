...
```json
{
  ...
  "controlStyles[34].target": "Taskbar.TaskbarFrame#TaskbarFrame",
  "controlStyles[34].styles[0]": "Height=30",
  "controlStyles[35].target": "Windows.UI.Xaml.Controls.Border#LargeTicker1",
  "controlStyles[35].styles[0]": "Margin=1,-7,0,0",
  "controlStyles[35].styles[1]": "RenderTransform:=<ScaleTransform ScaleX=\"0.75\" ScaleY=\"0.75\" />",
  "controlStyles[36].target": "SearchUx.SearchUI.SearchButtonRootGrid#SearchBoxButtonRootPanel > Windows.UI.Xaml.Controls.Border#BackgroundElement",
  "controlStyles[36].styles[0]": "Margin=0,4,0,4",
  "controlStyles[37].target": "SearchUx.SearchUI.SearchButtonControl",
  "controlStyles[37].styles[0]": "Margin=0,-4,0,-4",
  "controlStyles[38].target": "Microsoft.UI.Xaml.Controls.AnimatedVisualPlayer#Icon",
  "controlStyles[39].target": "Windows.UI.Xaml.Controls.Image#Icon",
  "controlStyles[38].styles[0]": "Width=16",
  "controlStyles[39].styles[0]": "Width=16",
  "controlStyles[38].styles[1]": "Height=16",
  "controlStyles[39].styles[1]": "Height=16",
  "controlStyles[40].target": "Grid#SystemTrayFrameGrid",
  "controlStyles[40].styles[0]": "Margin=0,0,0,18",
  "controlStyles[41].target": "SystemTray.TextIconContent > Grid#ContainerGrid > SystemTray.AdaptiveTextBlock#Base > TextBlock#InnerTextBlock",
  "controlStyles[41].styles[0]": "FontSize=14",
  "controlStyles[42].target": "SystemTray.ImageIconContent > Grid#ContainerGrid > Image",
  "controlStyles[42].styles[0]": "Width=14",
  "controlStyles[42].styles[1]": "Height=14"
}
```
</details>
...
```json
{
  ...
  "styleConstants[5]": "bb=#20FFFFFF",
  "styleConstants[6]": "bt=1",
  "controlStyles[34].target": "Taskbar.TaskbarFrame > Grid#RootGrid > Taskbar.TaskbarBackground > Grid > Rectangle#BackgroundFill",
  "controlStyles[34].styles[0]": "Visibility=Collapsed",
  "controlStyles[35].target": "Taskbar.TaskbarFrame#TaskbarFrame",
  "controlStyles[35].styles[0]": "Height=53",
  "controlStyles[36].target": "Taskbar.TaskbarFrame#TaskbarFrame > Grid#RootGrid",
  "controlStyles[36].styles[0]": "Background:=$mbg",
  "controlStyles[36].styles[1]": "BorderThickness=$bt",
  "controlStyles[36].styles[2]": "BorderBrush:=$bb",
  "controlStyles[36].styles[3]": "CornerRadius=$mcr",
  "controlStyles[36].styles[4]": "Margin=5,0,5,5",
  "controlStyles[37].target": "Taskbar.TaskbarBackground#BackgroundControl > Windows.UI.Xaml.Controls.Grid > Windows.UI.Xaml.Shapes.Rectangle#BackgroundStroke",
  "controlStyles[37].styles[0]": "Visibility=Collapsed",
  "controlStyles[38].target": "Grid#SystemTrayFrameGrid",
  "controlStyles[38].styles[0]": "Margin=0,-2,6,4"
}
```
</details>
...
```json
{
  ...
  "styleConstants[5]": "bb=#20FFFFFF",
  "styleConstants[6]": "bt=1",
  "controlStyles[34].target": "Microsoft.UI.Xaml.Controls.ItemsRepeater#TaskbarFrameRepeater",
  "controlStyles[34].styles[0]": "Margin=0,1,0,0",
  "controlStyles[35].target": "SystemTray.ChevronIconView",
  "controlStyles[35].styles[0]": "Margin=0,1,2,0",
  "controlStyles[36].target": "SystemTray.NotifyIconView > Windows.UI.Xaml.Controls.Grid#ContainerGrid > Windows.UI.Xaml.Controls.Border#BackgroundBorder",
  "controlStyles[36].styles[0]": "Margin=2,5,2,4",
  "controlStyles[37].target": "SystemTray.IconView#SystemTrayIcon > Windows.UI.Xaml.Controls.Grid#ContainerGrid > Windows.UI.Xaml.Controls.Border#BackgroundBorder",
  "controlStyles[37].styles[0]": "Margin=2,5,2,4",
  "controlStyles[38].target": "SystemTray.OmniButton#ControlCenterButton > Windows.UI.Xaml.Controls.Grid > Windows.UI.Xaml.Controls.Border#BackgroundBorder",
  "controlStyles[38].styles[0]": "Margin=2,5,2,4",
  "controlStyles[39].target": "SystemTray.OmniButton#NotificationCenterButton > Windows.UI.Xaml.Controls.Grid > Windows.UI.Xaml.Controls.Border#BackgroundBorder",
