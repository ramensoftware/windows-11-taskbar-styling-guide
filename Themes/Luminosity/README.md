...
```json
{
  ...
  "controlStyles[4].target": "SystemTray.NotifyIconView#NotifyItemIcon",
  "controlStyles[4].styles[0]": "CornerRadius=$bcr",
  "controlStyles[4].styles[1]": "Padding=2",
  "controlStyles[4].styles[2]": "Margin=0,2,0,2",
  "controlStyles[5].target": "SystemTray.ChevronIconView",
  "controlStyles[5].styles[0]": "CornerRadius=$bcr",
  "controlStyles[5].styles[1]": "Padding=2",
  "controlStyles[5].styles[2]": "Margin=0,2,0,2",
  "controlStyles[6].target": "SystemTray.OmniButton",
  "controlStyles[6].styles[0]": "CornerRadius=$bcr",
  "controlStyles[6].styles[1]": "Padding=2",
  "controlStyles[6].styles[2]": "Margin=0,2,0,2",
  ...
  "controlStyles[7].styles[4]": "Shadow:=",
  ...
  "controlStyles[10].target": "Windows.UI.Xaml.Shapes.Rectangle#HorizontalTrackRect",
  "controlStyles[10].styles[0]": "Fill:=#10FFFFFF",
  "controlStyles[11].target": "Taskbar.TaskbarBackground#HoverFlyoutBackgroundControl > Grid > Rectangle#BackgroundFill",
  "controlStyles[11].styles[0]": "Fill:=$t",
  "controlStyles[12].target": "Windows.UI.Xaml.Controls.Grid#HoverFlyoutGrid > Windows.UI.Xaml.Controls.Border#HoverFlyoutBackground",
  "controlStyles[12].styles[0]": "Background:=$mbg",
  "controlStyles[12].styles[1]": "CornerRadius=$mcr",
  "controlStyles[12].styles[2]": "Shadow:=",
  "controlStyles[12].styles[3]": "Margin=1,1,1,1",
  "controlStyles[13].target": "Taskbar.TaskItemThumbnailView > Grid@CommonStates > Border#BackgroundBorder",
  ...
  "controlStyles[14].target": "Windows.UI.Xaml.Controls.Button#CloseButton",
  "controlStyles[14].styles[0]": "CornerRadius=$mcr",
  "controlStyles[15].target": "Windows.UI.Xaml.Controls.ContentPresenter#BorderElement",
  "controlStyles[15].styles[0]": "CornerRadius=16",
  "controlStyles[15].styles[1]": "Margin=-1,-1,-1,-1",
  ...
  "controlStyles[16].styles[1]": "CornerRadius=$wcr",
  ...
  "controlStyles[17].styles[0]": "Background:=<WindhawkBlur BlurAmount=\"30\" TintColor=\"#00000000\" />",
  "controlStyles[18].target": "WindowsInternal.ComposableShell.Experiences.Switcher.VirtualDesktopBarElement#VirtualDesktopBar > Grid > Border",
  "controlStyles[18].styles[0]": "CornerRadius=$wcr",
  "controlStyles[19].target": "WindowsInternal.ComposableShell.Experiences.Switcher.VirtualDesktopBarElement#VirtualDesktopBar",
  "controlStyles[19].styles[0]": "Width=Auto",
  "controlStyles[19].styles[1]": "Visibility=Visible",
  "controlStyles[19].styles[2]": "MaxWidth:=900",
  "controlStyles[19].styles[3]": "BorderThickness=$bt",
  "controlStyles[19].styles[4]": "BorderBrush=$bb",
  "controlStyles[19].styles[5]": "Shadow:=",
  "controlStyles[20].target": "Windows.UI.Xaml.Controls.Grid#MainGrid",
  "controlStyles[20].styles[0]": "CornerRadius=$mcr",
  "controlStyles[20].styles[1]": "BorderThickness=$bt",
  "controlStyles[20].styles[2]": "BorderBrush=$bb",
  "controlStyles[21].target": "Windows.UI.Xaml.Controls.Button#VirtualDesktopElementCloseButton",
  "controlStyles[21].styles[0]": "CornerRadius=$bcr",
  "controlStyles[22].target": "Windows.UI.Xaml.Controls.Border#SnapBarBorder",
  "controlStyles[22].styles[0]": "Background:=$mbg",
  "controlStyles[22].styles[1]": "CornerRadius=$mcr",
  "controlStyles[22].styles[2]": "RenderTransform:=<TranslateTransform X=\"0\" Y=\"-20\" />",
  "controlStyles[22].styles[3]": "Margin=0,0,0,-10",
  "controlStyles[22].styles[4]": "Shadow:=",
  "controlStyles[23].target": "Windows.UI.Xaml.Controls.Border#SnapPickerBorder",
  ...
  "controlStyles[25].styles[1]": "CornerRadius=$mcr",
  "controlStyles[25].styles[2]": "Shadow:=",
  "controlStyles[26].target": "MenuFlyoutPresenter > Border",
  ...
  "controlStyles[27].target": "Windows.UI.Xaml.Controls.MenuFlyoutItem",
  "controlStyles[27].styles[0]": "CornerRadius=$bcr",
  "controlStyles[28].target": "Windows.UI.Xaml.Controls.MenuFlyoutSubItem",
  "controlStyles[28].styles[0]": "CornerRadius=$bcr",
  "controlStyles[29].target": "Windows.UI.Xaml.Controls.ToolTip > Windows.UI.Xaml.Controls.ContentPresenter#LayoutRoot",
  ...
  "controlStyles[29].styles[4]": "Shadow:=",
  ...
  "controlStyles[30].target": "Taskbar.TaskbarFrame#TaskbarFrame",
  "controlStyles[30].styles[0]": "Height=30",
  "controlStyles[31].target": "Windows.UI.Xaml.Controls.Border#LargeTicker1",
  "controlStyles[31].styles[0]": "Margin=1,-7,0,0",
  "controlStyles[31].styles[1]": "RenderTransform:=<ScaleTransform ScaleX=\"0.75\" ScaleY=\"0.75\" />",
  ...
  "controlStyles[33].styles[0]": "Margin=0,-4,0,-4",
  "controlStyles[34].target": "Microsoft.UI.Xaml.Controls.AnimatedVisualPlayer#Icon",
  "controlStyles[35].target": "Windows.UI.Xaml.Controls.Image#Icon",
  "controlStyles[34].styles[0]": "Width=16",
  "controlStyles[35].styles[0]": "Width=16",
  "controlStyles[34].styles[1]": "Height=16",
  "controlStyles[35].styles[1]": "Height=16",
  "controlStyles[36].target": "Grid#SystemTrayFrameGrid",
  "controlStyles[36].styles[0]": "Margin=0,0,0,18",
  "controlStyles[37].target": "SystemTray.TextIconContent > Grid#ContainerGrid > SystemTray.AdaptiveTextBlock#Base > TextBlock#InnerTextBlock",
  "controlStyles[37].styles[0]": "FontSize=14",
  "controlStyles[38].target": "SystemTray.ImageIconContent > Grid#ContainerGrid > Image",
  "controlStyles[38].styles[0]": "Width=14",
  "controlStyles[38].styles[1]": "Height=14"
}
```
</details>
...
```json
{
  ...
  "styleConstants[6]": "bt=1",
  "controlStyles[30].target": "Taskbar.TaskbarFrame#TaskbarFrame",
  "controlStyles[30].styles[0]": "Height=53",
  "controlStyles[31].target": "Taskbar.TaskbarFrame#TaskbarFrame > Grid#RootGrid",
  "controlStyles[31].styles[0]": "Margin=5,0,5,5",
  "controlStyles[31].styles[1]": "BorderThickness=$bt",
  "controlStyles[31].styles[2]": "BorderBrush:=$bb",
  "controlStyles[31].styles[3]": "CornerRadius=$mcr",
  "controlStyles[32].target": "Taskbar.TaskbarBackground#BackgroundControl > Windows.UI.Xaml.Controls.Grid > Windows.UI.Xaml.Shapes.Rectangle#BackgroundStroke",
  "controlStyles[32].styles[0]": "Visibility=Collapsed",
  "controlStyles[33].target": "Grid#SystemTrayFrameGrid",
  "controlStyles[33].styles[0]": "Margin=0,-2,6,5"
}
```
</details>
