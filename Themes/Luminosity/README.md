...
- **Left Taskbar Alignment (Dock):** When using **Left Taskbar Alignment**, the Widget clip into the **SystemTray**. If you wish, to correct the problem, you can change:
...
```json
{
  ...
  "controlStyles[24].styles[2]": "Margin=0,0,1,0",
  ...
  "controlStyles[28].styles[2]": "RenderTransform:=<TranslateTransform X=\"0\" Y=\"-20\" />",
  "controlStyles[28].styles[3]": "Margin=0,0,0,-10",
  "controlStyles[28].styles[4]": "Shadow:=",
